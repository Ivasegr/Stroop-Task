...
expName = 'Stroop Task'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\Iseba\\OneDrive\\Documents\\From Dropbox\\Projects\\PsychClinic\\Eyetracking & Suicide\\Stroop Task\\Stroop Task_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    text_3 = visual.TextStim(win=win, name='text_3',
        text='Hello,\n  You will see different words appear on the screen. Please press the button that corresponds to the colour of those words, not to their meaning. Press "m" for blue colour and "c" for red colour.\n\nPress "Space" to continue.',
        font='Arial',
    ...
    text_4 = visual.TextStim(win=win, name='text_4',
        text='Thank you for completing this task. Please let the experiementer know that you have finished.',
        font='Arial',
        pos=(0, 0), height=0.05, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
    ...
    IntroductionComponents = [text_3, key_resp_2]
    ...
    for thisTrial in trials:
        ...
        continueRoutine = True
        # update component parameters for each repeat
        thisExp.addData('StroopTrial.started', globalClock.getTime(format='float'))
        key_resp.keys = []
        key_resp.rt = []
        _key_resp_allKeys = []
        ...
        text.setText(word)
        # keep track of which components have finished
        StroopTrialComponents = [key_resp, text]
        ...
        while continueRoutine:
            ...
            if key_resp.status == STARTED and not waitOnFlip:
                theseKeys = key_resp.getKeys(keyList=['m', 'c'], ignoreKeys=["escape"], waitRelease=False)
                ...
                if len(_key_resp_allKeys):
                    ...
                    # was this correct?
                    if (key_resp.keys == str(correctAnswer)) or (key_resp.keys == correctAnswer):
                        key_resp.corr = 1
                    else:
                        key_resp.corr = 0
                    # a response ends the routine
        ...
        for thisComponent in StroopTrialComponents:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        thisExp.addData('StroopTrial.stopped', globalClock.getTime(format='float'))
        # check responses
